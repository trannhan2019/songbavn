                ...
                <div class="col-12">
                    <form action="admin/content/{{ $menu->id }}/add-{{ $menu->slug }}.html" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="menu_id" class="form-control" readonly value="{{ $menu_cocau->name }}">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="ckeditor_cc" cols="30" rows="50"></textarea>  
                        </div>
                        <div class="form-group">
                            <label>Thời gian khởi tạo</label>
                            <div class="input-group date" id="datetimepickerCreatcc" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerCreatcc" name="created_at"/>
                                <div class="input-group-append" data-target="#datetimepickerCreatcc" data-toggle="datetimepicker">
...
<script type="text/javascript">
    $(function () {
        $('#datetimepickerCreatcc').datetimepicker({
            locale: 'vi',
