                            ...
                            <form action="{{ route('admin.factory.edit',$factory->id) }}" method="post" >
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-sm" type="number" name="ratedpower" value="{{ $factory->ratedpower }}" min="0" max="100" step="0.1" data-decimals="1"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-sm" type="number" name="MNHlowest" value="{{ $factory->MNHlowest }}" min="0" max="500" step="0.01" data-decimals="2"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-sm" type="number" name="MNHnormal" value="{{ $factory->MNHnormal }}" min="0" max="500" data-decimals="2" step="0.01"/>
