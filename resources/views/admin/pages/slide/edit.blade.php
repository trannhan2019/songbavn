                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datetimepickerCreatsl" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerCreatsl" data-toggle="datetimepicker" name="created_at" value="{{ $slide->created_at ? $user->created_at->format('d/m/Y H:h'):''}}"/>
