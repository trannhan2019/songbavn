    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Thêm: <small>Slide</small></h1>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <form action="{{ route('admin.slide.add') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control-sm" type="number" name="location" value="0" min="1" max="100" step="1"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datetimepickerCreatsl" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerCreatsl" data-toggle="datetimepicker" name="created_at"/>
