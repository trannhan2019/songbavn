...
<div class="content-wrapper">
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <form action="admin/content/{{ $menu->id }}/{{ $content->id }}/edit-{{ $menu->slug }}.html" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="ckeditor_lh" cols="30" rows="50">{{ $content->content }}</textarea>  
                        </div>
                        <div class="form-group">
