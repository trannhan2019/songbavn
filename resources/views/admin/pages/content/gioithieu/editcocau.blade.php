                ...
                <div class="col-12">
                    <form action="admin/content/{{ $menu->id }}/{{ $sub_content->id }}/edit-{{ $menu->slug }}.html" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="ckeditor_cc" cols="30" rows="50">{{ $sub_content->content }}</textarea>  
                        </div>
                        <div class="form-group">
                            <label>Thời gian khởi tạo</label>
                            <div class="input-group date" id="datetimepickerEditcc" data-target-input="nearest">
                                <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerEditcc" name="created_at" value="{{ $sub_content->created_at ? $sub_content->created_at->format('d/m/Y H:h'):''}}"/>
                                <div class="input-group-append" data-target="#datetimepickerEditcc" data-toggle="datetimepicker">
...
<script type="text/javascript">
    $(function () {
        $('#datetimepickerEditcc').datetimepicker({
            locale: 'vi',
