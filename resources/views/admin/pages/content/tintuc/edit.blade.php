                            ...
                            <form action="admin/content/{{ $tintuc->id }}/edit-tin-tuc.html" method="post" enctype="multipart/form-data">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datetimepickerEdittt">
                                            <input type="text" class="form-control" name="created_at" value="{{ date("d/m/Y", strtotime($tintuc->created_at))}}">
...
@section('script')
    ...
    <script type="text/javascript">
		$(function () {
			$('#datetimepickerEdittt').datepicker({
                format: "dd/mm/yyyy",
                weekStart: 1,
                todayBtn: "linked",
                language: "vi",
