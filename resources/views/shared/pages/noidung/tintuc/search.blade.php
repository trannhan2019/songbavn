    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0 pl-0">
                ...
                <li class="breadcrumb-item"><a href="{{ route('tintucslug',$menu->slug) }}">{{ $menu->name }}</a></li> 
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="card-header my-2">
                ...
                <p class="mb-0"> Hiển thị <strong>{{ count($content) }}</strong> kết quả trên tổng số {{ $content->total() }} kết quả được tìm thấy</p>
            </div>
