                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card card-primary">
                            ...
                            <form action="admin/content/{{ $content->id }}/edit-quan-he-co-dong.html" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="highlights" {{ $content->highlights==1 ? 'checked':'' }} value="1">Nổi bật đầu trang chủ
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="notification" {{ $content->notification==1 ? 'checked':'' }} value="1">Có hiển thị
                                            </label>
                                        </div>
                                        <div class="form-check-inline">
                                            <label class="form-check-label">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="datetimepickerCreatcd" data-target-input="nearest">
                                            <input type="text" class="form-control datetimepicker-input" data-target="#datetimepickerCreatcd" name="created_at" value="{{ $content->created_at ? $content->created_at->format('d/m/Y H:h'):''}}"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea name="content" id="ckeditor_cd" cols="30" rows="50">{{ $content->content }}</textarea>  
                                    </div>
                                </div>
